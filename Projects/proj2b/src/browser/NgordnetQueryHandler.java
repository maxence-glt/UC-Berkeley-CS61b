...
public abstract class NgordnetQueryHandler implements Route {
    public abstract String handle(Projects.proj2b.src.browser.NgordnetQuery q);
    ...
    private static NgordnetQuery readQueryMap(QueryParamsMap qm) {
        ...
        return new Projects.proj2b.src.browser.NgordnetQuery(words, startYear, endYear, k);
    }
